...
function getDecoratedType(type, possibleUnionName) {
    var _a, _b;
    ...
    if (type.flags === typescript_1.TypeFlags.Object && ((_b = type.symbol) === null || _b === void 0 ? void 0 : _b.name) === 'Array') {
        ...
        return Object.assign(Object.assign({}, innerType), { isArray: true, isArrayNullable: isNullable, isArrayUndefinable: isUndefinable });
    }
